...
<html>
    ...
    <body>
        ...
        <p class="path">
            ...
            >
            <a class="path" href="${cp}/formularios/classificacoesInternas/listagem.jsp">Classificações Internas</a>
            >
        ...
        <form method="post" action="${cp}/processaClassificacoesInternas">
            ...
            <input name="id" type="hidden" value="${requestScope.classInterna.id}"/>
                ...
                <tr>
                    ...
                    <td>
                        <input name="descricao"
                               ...
                               maxlength="45"
                               required
                               value="${requestScope.classInterna.descricao}"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="valorAluguel"
                               ...
                               min="0"
                               required
                               value="${requestScope.classInterna.valorAluguel}"/>
                    </td>
                </tr>
                <tr>
                    <td>
